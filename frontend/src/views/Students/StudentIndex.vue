    ...
    <table class="w-full text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr v-for="student in students" :key="student.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-green-200">
                ...
                <td class="px-3 py-4">
                    {{ student.area +', '+ student.city  + ' ' + student.zip }}
                </td>
                <td class="px-3 py-4">  
                    <RouterLink :to="{ name: 'StudentEdit', params:{ id: student.id }}" class="px-2 pt-2 pb-2.5 pr-6 pl-6 bg-yellow-600 hover:text-white rounded-md hover:bg-yellow-700 text-white font-semibold">Edit</RouterLink>
